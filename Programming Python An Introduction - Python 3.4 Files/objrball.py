# objrball.py -- Simulation of a racquetball game
#   Illistrates design with objects

from random import random

class Player:
    # A Player keeps track of service probibility and score

    def __init__(self, prob):
        # Creates a player with this probability
        self.prob = prob
        self.score = 0
...
class SimStats:
    # SimStats handles accumulation for a series of games
    def __init__(self):
...
def printIntro():
    ...
    print("indicated by a probability (a number between 1 and 0) that")
