# gpa.py
#   Program to find student withthe higest GPA
...
def makeStudent(infoStr):
        ...
        # returns a corrosponding Student object
...
def main():
        ...
        # set best to the record for the first studen in the file
        best = makeStuden(infile.readlines())
